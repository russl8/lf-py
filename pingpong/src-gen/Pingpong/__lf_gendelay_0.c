...
#include "include/Pingpong/_lf_GenDelay_0.h"
...
#line 20 "/Users/russl8/github/lf-py/pingpong/src-gen/Pingpong/__lf_gendelay_0.c"
}
...
#line 42 "/Users/russl8/github/lf-py/pingpong/src-gen/Pingpong/__lf_gendelay_0.c"
}
#include "include/api/reaction_macros_undef.h"
__lf_gendelay_0_self_t* new___lf_gendelay_0() {
    __lf_gendelay_0_self_t* self = (__lf_gendelay_0_self_t*)lf_new_reactor(sizeof(__lf_gendelay_0_self_t));
    ...
    self->_lf__act.tmplt.length = 1;
    self->_lf_act.length = 1;
